...
public class SelectedBankAdapter extends BaseAdapter {
	private Context context;
	private List<CityBank> listCityBank;
	private HashMap<String, Integer> bankiconMaps;

	public SelectedBankAdapter(Context context, List<CityBank> listCityBank) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (view == null) {
			view = LayoutInflater.from(context).inflate(
					R.layout.item_gridview_selected_bank, null);
