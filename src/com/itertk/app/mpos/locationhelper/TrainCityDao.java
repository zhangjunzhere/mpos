...
/** 
 * DAO for table traincities.
*/
public class TrainCityDao extends AbstractDao<TrainCity, String> {

    public static final String TABLENAME = "traincities";

    /**
     * Properties of entity TrainCity.<br/>
    ...
    */
    ...
    public TrainCityDao(DaoConfig config) {
        super(config);
    }
    
    public TrainCityDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'traincities' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'traincities'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, TrainCity entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public TrainCity readEntity(Cursor cursor, int offset) {
        TrainCity entity = new TrainCity( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, TrainCity entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(TrainCity entity, long rowId) {
        return entity.getName();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(TrainCity entity) {
        if(entity != null) {
            return entity.getName();
        } else {
            return null;
